              ...
              <div
                ...
                <div className={`project__image_container ${project.order} ${project.class}`}>
                  <img
                    ...
                    loading='lazy'
                  />
                  {project.status && <span className="project__status rounded-pill">{project.status}</span>}
                </div>
                <div className='project__text_container'>
                  <h3 className={`project__title ${project.class}`}>{project.name}</h3>
                  <p className='project__descryption'>{project.description}</p>
                  <div className='project__links_container'>
                    <a href={project.urlSite} target='_blank' rel="noreferrer" className='project__link'>
                      <span>Visitar</span>
                    </a>
                    {project.urlGithub && (
                      <a href={project.urlGithub} target='_blank' rel="noreferrer" className='project__link'>
                        <span>Github</span>
                      </a>
                    )}
                  </div>
